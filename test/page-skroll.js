! function(e, t, a) {
    ...
    S = {
      init: function(r) {
        ...
        n.liveSelector && (this.selector += "," + n.liveSelector), l = l ? l + "," + this.selector : this.selector, n.defaultSelector && ("object" == typeof e(l) && 0 !== e(l).length || (l = C)), n.clickEvents && e(a).undelegate("." + _).delegate(l, "click." + _, function(t) {
          ...
          n.excludeSelectors && a.is(n.excludeSelectors) || l && -1 !== l.indexOf("#/") || (I._reset.call(null), f = a.data("ps2id-offset") || 0, I._isValid.call(null, l, s) && I._findTarget.call(null, l) && (t.preventDefault(), i = "selector", o = a, I._setClasses.call(null, !0), I._scrollTo.call(null)))
      ...
      destroy: function() { e(t).unbind("." + _), e(a).undelegate("." + _).removeData(_), e("._" + _ + "-t").removeData(_), I._removeClasses.call(null, !0) }
    },
    I = {
      ...
      _setup: function() {
        ...
        return e(t).each(function() {
          ...
          if (I._isValid.call(null, o, r)) {
            if (n.excludeSelectors && i.is(n.excludeSelectors)) return;
            var c = -1 !== o.indexOf("#/") ? o.split("#/")[1] : o.split("#")[1],
              u = e(-1 !== c.indexOf("%") ? a.getElementById(c) : "#" + c);
            if (u.length > 0) {
              n.highlightByNextTarget && u !== s && (s ? s.data(_, { tn: u }) : u.data(_, { tn: "0" }), s = u), u.hasClass("_" + _ + "-t") || u.addClass("_" + _ + "-t"), u.data(_, { i: l }), i.hasClass("_" + _ + "-h") || i.addClass("_" + _ + "-h");
              var h = I._findHighlight.call(null, c);
              I._setClasses.call(null, !1, u, h), m = l, l++, l == e(t).length && I._extendClasses.call(null)
            }
          }
        })
      },
      ...
      _findTarget: function(t) {
        var l = -1 !== t.indexOf("#/") ? t.split("#/")[1] : t.split("#")[1],
          s = e(-1 !== l.indexOf("%") ? a.getElementById(l) : "#" + l);
        if (s.length < 1 || "fixed" === s.css("position")) {
          if ("top" !== l) return;
          s = e("body")
        }
        return r = s, u || (u = n.layout), h = I._setOffset.call(null), c = [(s.offset().top - h[0]).toString(), (s.offset().left - h[1]).toString()], c[0] = c[0] < 0 ? 0 : c[0], c[1] = c[1] < 0 ? 0 : c[1], c
      },
      _setOffset: function() {
        h || (h = n.offset ? n.offset : 0), f && (h = f);
        var t, a, l, s;
        switch (typeof h) {
          case "object":
          case "string":
      ...
      _findHighlight: function(a) {
        var l = t.location,
          ...
          s = l.pathname;
        return -1 !== n.indexOf("'") && (n = n.replace("'", "\\'")), -1 !== s.indexOf("'") && (s = s.replace("'", "\\'")), n = decodeURIComponent(n), s = decodeURIComponent(s), e("._" + _ + "-h[href='#" + a + "'],._" + _ + "-h[href='" + n + "#" + a + "'],._" + _ + "-h[href='" + s + "#" + a + "'],._" + _ + "-h[href='#/" + a + "'],._" + _ + "-h[href='" + n + "#/" + a + "'],._" + _ + "-h[href='" + s + "#/" + a + "']")
      },
      ...
      _removeClasses: function(t) { e("." + n.clickedClass).removeClass(n.clickedClass), e("." + n.targetClass).removeClass(n.targetClass + " " + n.targetClass + "-first " + n.targetClass + "-last"), e("." + n.highlightClass).removeClass(n.highlightClass + " " + n.highlightClass + "-first " + n.highlightClass + "-last"), t && (e("._" + _ + "-t").removeClass("_" + _ + "-t"), e("._" + _ + "-h").removeClass("_" + _ + "-h")) },
      _currentTarget: function(a) {
        ...
        var g = e(t).height(),
          ...
          O = I,
          M = d > C ? I * (d / C) : I,
          b = [i.top <= g / m, i.bottom >= g / S, i.left <= d / O, i.right >= d / M];
        if (n.highlightByNextTarget) { var y = a.data(_).tn; if (y) { var x = y[0].getBoundingClientRect(); "vertical" === n.layout ? b = [i.top <= g / 2, x.top > g / 2, 1, 1] : "horizontal" === n.layout && (b = [1, 1, i.left <= d / 2, x.left > d / 2]) } }
      ...
      _scrollTo: function() {
        ...
        switch (u) {
          case "horizontal":
            o != c[1] && (I._callbacks.call(null, "onStart"), a.stop().animate({ scrollLeft: c[1] }, l, s).promise().then(function() { I._callbacks.call(null, "onComplete") }));
            break;
          case "auto":
            if (i != c[0] || o != c[1])
              if (I._callbacks.call(null, "onStart"), navigator.userAgent.match(/(iPod|iPhone|iPad|Android)/)) {
                var r;
                a.stop().animate({ pageYOffset: c[0], pageXOffset: c[1] }, { duration: l, easing: s, step: function(e, a) { "pageXOffset" == a.prop ? r = e : "pageYOffset" == a.prop && t.scrollTo(r, e) } }).promise().then(function() { I._callbacks.call(null, "onComplete") })
              } else a.stop().animate({ scrollTop: c[0], scrollLeft: c[1] }, l, s).promise().then(function() { I._callbacks.call(null, "onComplete") });
            break;
          default:
            i != c[0] && (I._callbacks.call(null, "onStart"), a.stop().animate({ scrollTop: c[0] }, l, s).promise().then(function() { I._callbacks.call(null, "onComplete") }))
        }
      },
      ...
      _scrollSpeed: function() {
        ...
        return o && o.length && o.add(o.parent()).each(function() {
          ...
          if (a.attr("class")) {
            ...
            for (var n in l)
              if (String(l[n]).match(/^ps2id-speed-\d+$/)) { t = l[n].split("ps2id-speed-")[1]; break }
          }
        }), parseInt(t)
      },
      ...
      _reset: function() { u = h = f = !1 },
      _isInit: function() { s || S.init.apply(this) },
      _live: function() { g = setTimeout(function() { n.live ? e(I._highlightSelector()).length !== m && I._setup.call(null) : g && clearTimeout(g), I._live.call(null) }, 1e3) },
      _easing: function() {
        function t(e) {
          var t = 7.5625,
            a = 2.75;
  ...
  I._easing.call(), e.fn[p] = function(t) { return S[t] ? S[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist") : S.init.apply(this, arguments) }, e[p] = function(t) { return S[t] ? S[t].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof t && t ? void e.error("Method " + t + " does not exist") : S.init.apply(this, arguments) }, e[p].defaults = v
